...
def test_successful_delete_self_pet_with_valid_key_aliens_id():
    """Проверяем возможность по чужому id удаления питомца
    со своего аккаунта получение непосредственно с чужого аккаунта id"""
...
def test_successful_delete_self_pet_valid_key_aliens_id():
    """Проверяем возможность получение чужому id со своего аккаунта и с помощью его удаления питомца"""
